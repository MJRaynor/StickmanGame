...
class Game:
    def __init__(self):
        self.tk = Tk()
        self.tk.title("Dash for the Door!")
...
def intro():
    tk1 = Tk()
    canvas1 = Canvas(tk1, width=500, height=500)
    tk1.title("Dash for the Door!")
    canvas1.pack()
    for i in range (0,2):
            my_image=PhotoImage(file='DashDoor.gif')
            canvas1.create_image(0,0,anchor=NW, image=my_image)
            tk1.update()
            time.sleep(.1)
            my_image=PhotoImage(file='DashDoor1.gif')
            canvas1.create_image(0,0,anchor=NW, image=my_image)
            tk1.update()
            time.sleep(.1)
            my_image=PhotoImage(file='DashDoor2.gif')
            canvas1.create_image(0,0,anchor=NW, image=my_image)
            tk1.update()
            time.sleep(.1)
            my_image=PhotoImage(file='DashDoor3.gif')
            canvas1.create_image(0,0,anchor=NW, image=my_image)
            tk1.update()
            time.sleep(.1)
            my_image=PhotoImage(file='DashDoor.gif')
...
bounce.set_volume(0.05)
clapping = pygame.mixer.Sound('claps.wav')
clapping.set_volume(0.05)
warn = pygame.mixer.Sound('warning.wav')
warn.set_volume(0.05)
